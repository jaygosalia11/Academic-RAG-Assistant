  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography sx={{ color: "rgba(165,180,252,0.85)", fontWeight: 700, fontSize: "0.95rem", letterSpacing: "0.04em" }}>
            💬 Chats
          </Typography>
          <IconButton
            onClick={() => setDrawerOpen(false)}
            size="small"
            sx={{ color: "rgba(165,180,252,0.6)", "&:hover": { color: "rgba(165,180,252,1)" } }}
          >
        ...
        <Box sx={{ px: 2, pb: 2, overflowY: "auto", flex: 1 }}>
          {sessions.map((s) => (
            <Box
              ...
              onClick={() => { loadSession(s.id); setDrawerOpen(false); }}
              sx={{
                p: 1.2,
                mb: 0.5,
                borderRadius: "8px",
                cursor: "pointer",
                fontSize: "0.82rem",
                color: activeSession === s.id ? "rgba(165,180,252,0.95)" : "rgba(165,180,252,0.5)",
                background: activeSession === s.id ? "rgba(99,102,241,0.2)" : "transparent",
                border: activeSession === s.id ? "1px solid rgba(99,102,241,0.3)" : "1px solid transparent",
                whiteSpace: "nowrap",
                overflow: "hidden",
